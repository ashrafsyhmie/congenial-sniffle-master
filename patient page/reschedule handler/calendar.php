...
function build_calendar($month, $year, $patient_id, $conn)
{
    ...
    while ($currentDay <= $numberDays) {
        ...
        if ($fullyBooked || $date < date('Y-m-d')) {
            ...
            $calendar .= "<td class='$today'><h4>$currentDay</h4> <a href='timeslots.php?date=" . $date . "&appointment_id=" . $_POST['appointment_id'] . "' class='btn btn-success btn-xs'><span class='glyphicon glyphicon-ok'></span> Book Now</a></td>";
        }

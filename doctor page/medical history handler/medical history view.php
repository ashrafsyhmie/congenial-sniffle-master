...
function fetchLatestAppointmentByPatient($conn, $patient_id)
{
  // SQL query to get the latest appointment for the specific patient
  ...
  if (mysqli_num_rows($result) > 0) {
    // Fetch the latest appointment row
...
$latestAppointment = fetchLatestAppointmentByPatient($conn, $patient_id);
